...
export const neighborhoodParks: Record<string, NeighborhoodParkCopy> = {
  "/neighborhoods/centennial-hills": {
    ...
    body: "We measure park acreage on the same US-95 afternoon as mountain-view streets. Suite 103 is 15–20 minutes west. Do not treat a listing photo as the park.",
    pins: [
      {
        name: "Centennial Hills Park",
        note: "About 120 acres: sports fields, playground, skate park, dog park. First rec stop from 851 W Lone Mountain Rd on a Centennial Hills day.",
      },
      {
      ...
      },
      {
        ...
        note: "Two public courses, 36 holes, on the west-valley side toward Summerlin. Call (702) 820-5408 to sequence golf vs the 120-acre park.",
      },
    ],
  },
  "/neighborhoods/mountains-edge": {
    h3: "Exploration Peak summit trail vs Mountains Edge Regional Park splash pad",
    body: "Southwest rec is two parks, not one caption. We walk a trail at Exploration Peak before the splash pad so acreage and elevation are facts. Suite 103 is 20–30 minutes via the Beltway.",
    pins: [
      {
      ...
      },
      {
        ...
        note: "Public golf near the southwest plat. Southern Highlands Golf Club is a separate I-15 add-on. Call (702) 820-5408.",
      },
    ],
  },
};
