...
export const communityHighlights: Record<string, CommunityHighlightCopy> = {
  "/neighborhoods/summerlin": {
    ...
    body: "Summerlin is not one village. We count parks, trail miles, and golf campuses on the west loop from Suite 103 so the 22,500-acre plat is a map, not a slogan.",
    pins: [
      {
        name: "150+ parks and 150+ trail miles",
        note: "Howard Hughes villages share the trail spine. We walk one park and one trailhead the same afternoon as The Trails or Pueblo — typically 10–15 minutes from 851 W Lone Mountain Rd.",
      },
      {
        name: "Nine golf campuses including Red Rock Country Club",
        note: "Public and private courses sit on the same west clock as Downtown Summerlin. Call (702) 820-5408 to sequence golf streets vs interior lots.",
      },
    ],
  },
  "/neighborhoods/the-ridges": {
    h3: "Six Ridges villages and about 900 home sites — names before the gate",
    body: "The Ridges is nearly 800 acres above Red Rock Country Club. Gate lists are confirmed at Suite 103. Village names on the showing sheet are Bear's Best, Falcon Ridge, Azure, Talon Ridge, Silver Ridge, and Eagle Hills.",
    pins: [
      {
        name: "About 900 custom home sites",
        note: "Typical list prices exceed $2 million. Photography and access are scheduled from 851 W Lone Mountain Rd, Suite 103 — usually 15–20 minutes to the guardhouse.",
      },
      {
        name: "Bear's Best Golf Club inside the plat",
        note: "Jack Nicklaus tribute holes wind through the villages. We time the club campus before any public-mall stop. Call (702) 820-5408 for a private gate window.",
      },
    ],
  },
  "/neighborhoods/southern-highlands": {
    h3: "Fairway lots vs ridge streets on the 2,200-acre Southern Highlands plat",
    body: "This is an I-15 south block, 25–35 minutes from Suite 103. We do not mix it with a Summerlin village day. Fairway lots and ridge-top streets are two different showing clocks on the same plat.",
    pins: [
      {
      ...
      },
      {
        ...
        note: "Custom and semi-custom lots sit above the fairways. Guest lists are confirmed from Suite 103. Call (702) 820-5408. Janet Lundahl Elementary is mapped by address at ccsd.net/zoning.",
      },
    ],
  },
  "/neighborhoods/skye-canyon": {
    h3: "Model rows vs adjacent resales — Skye Canyon inventory that is not Centennial Hills",
    body: "Northwest afternoon, 20–25 minutes via the 215. Builder registration happens at Suite 103 first. New rows and resale streets sit next to the 15-acre Skye Center — we walk both so vintage vs new stucco is obvious.",
    pins: [
      {
        name: "Active builder model rows",
        note: "Register Dr. Jan as buyer agent before the first model visit. Plans and lot premiums change by phase; we pull the current sheet at 851 W Lone Mountain Rd.",
      },
      {
        name: "Resales next to Floyd Lamb Park",
        note: "About 680 acres of park sit immediately west. Compare shade and trail access against new-construction streets. Call (702) 820-5408.",
      },
    ],
  },
  "/neighborhoods/centennial-hills": {
    ...
    pins: [
      ...
      },
      {
        ...
        note: "Target, Costco, and theatres without a Summerlin hopscotch. Call (702) 820-5408 to time Arbor View High School by address after the park loop.",
      },
    ],
  },
  "/neighborhoods/green-valley": {
    ...
    body: "Founded in 1988. 35-year canopy and larger lots than most newer Henderson villages. The District is the tour midpoint, 25–35 minutes via I-215 east from Suite 103.",
    pins: [
      {
      ...
      },
      {
        ...
        note: "Green Valley High School and Coronado High School are named campuses by street. Call (702) 820-5408. Do not add Downtown Summerlin on this afternoon.",
      },
    ],
  },
  "/neighborhoods/henderson": {
    h3: "Water Street civic row vs MacDonald Highlands custom lots — two Henderson scales",
    body: "Henderson is Nevada's second-largest city, 25–35 minutes from Suite 103. We pick two contrasting villages on the first east day so you are not listing every mall. 60+ city parks sit under the civic layer.",
    pins: [
      {
      ...
      },
      {
        ...
        note: "Custom lots and shoreline product are a second Henderson clock. Call (702) 820-5408 with the commute target (Strip, Harry Reid International, or a named campus).",
      },
    ],
  },
  "/neighborhoods/inspirada": {
    h3: "Toll Brothers and Lennar rows around a 2,000-acre rec campus",
    body: "Inspirada is 30–40 minutes from 851 W Lone Mountain Rd. The rec campus is the point of the drive. Builder registration still starts at the west-valley office.",
    pins: [
      {
      ...
      },
      {
        ...
        note: "Plan rows change by village inside the 2,000 acres. St. Rose Dominican — Siena is the hospital pin. Call (702) 820-5408.",
      },
    ],
  },
  "/neighborhoods/north-las-vegas": {
    ...
    pins: [
      ...
      },
      {
        ...
        note: "Golf, rec, and casino retail as the north anchor. Legacy High School is mapped by street at ccsd.net/zoning. Call (702) 820-5408.",
      },
    ],
  },
    ...
    pins: [
      {
        ...
        note: "Strip about 15–20 minutes, Harry Reid International about 20 minutes from many streets. Timed from Suite 103 the week you tour.",
      },
      {
        name: "Rhodes Ranch Golf Club nearby",
        note: "Public golf adjacent to the southwest plat. Southern Highlands Golf Club is a separate I-15 add-on, not the same stop. Call (702) 820-5408.",
      },
    ],
  },
};
