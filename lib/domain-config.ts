...
export const DOMAIN_CONFIGS: Record<string, DomainConfig> = {
  "craigranchhomes.com": {
    ...
    description:
      "Search Craig Ranch homes for sale in North Las Vegas. Expert real estate guidance from Dr. Jan Duffy.",
    heroHeadline: "Craig Ranch Homes for Sale",
    heroSubheadline:
      "Established North Las Vegas living next to Craig Ranch Regional Park's trails, lake, and dog park.",
    keywords: [
    ...
    ctaSubheadline:
      "I know every street and floor plan in Craig Ranch. Let me help you find the right one.",
  },
  "consenzaestates.com": {
...
export function getCanonicalDomain(hostname: string): string {
  ...
  if (
    !clean ||
    NON_CANONICAL_HOSTNAME_PATTERN.test(clean) ||
