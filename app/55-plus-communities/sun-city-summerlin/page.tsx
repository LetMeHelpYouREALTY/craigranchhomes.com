...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "Nevada's largest 55+ community. Sun City Summerlin homes from $320K-$850K. 3 golf courses, 4 rec centers, 100+ clubs. Dr. Jan Duffy, BHHS specialist. Call (702) 820-5408.",
  keywords: [
...
<div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <section className="text-center bg-amber-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Walk one rec building and one course — 10–15 minutes from Suite 103
            </h2>
            <p className="text-xl text-amber-100 mb-8">
              Highland Falls, Palm Valley, and Eagle Crest plus four rec campuses. Pick one course and one rec building per visit. Call (702) 820-5408.
            </p>
